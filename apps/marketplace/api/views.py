...
class MarketplaceListingViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        ...
        # ✅ The service handles deduplication safely.
...
class MarketplaceSearchViewSet(viewsets.GenericViewSet):
    ...
    def featured(self, request):
        """
        ✅ FIXED: Now uses FeaturedListingService instead of non-existent ListingService method.
        ...
        try:
            ...
            # Extract the actual Listing objects from the FeaturedListing wrappers
            ...
            # Fallback: return empty list if service fails
